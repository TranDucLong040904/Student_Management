...
public class QuanLyGiangVienController {
    ...
    public void setEvent() {
        ...
        // Khi click vào nút xóa, thực hiện hành động xóa thông tin
        @Override
        public void mouseClicked(MouseEvent e) {
            // Thực hiện hành động xóa thông tin giảng viên ở đây
            int confirm = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn xóa thông tin giảng viên này?", "Xác nhận", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                // Gọi phương thức xóa thông tin giảng viên (cần triển khai cụ thể theo logic của bạn)
                deleteGiangVien();
            }
        }

        // Khi di chuột vào, đổi màu nút "Xóa"
        @Override
        public void mouseEntered(MouseEvent e) {
            btnDelete.setBackground(new Color(255, 0, 0));
        }

        // Khi chuột đi ra, đổi màu nút "Xóa"
        @Override
        public void mouseExited(MouseEvent e) {
